...
void GSM_MQTT::AutoConnect(void)
{
  /*
     ...
     This function is called whenever TCP csonnection is established (or re-established).
...
void GSM_MQTT::OnConnect(void)
{
  ...
  */
  ...
  publish(0, 0, 0, _generateMessageID(), "johanduran123", "Hello hacker");
  ...
  */
  if (MQTT.available())
  {
    /*
      ...
      You can write your code here
    */
    MQTT.publish(0, 0, 0, 3, "johanduran123", "Hello hacker");
