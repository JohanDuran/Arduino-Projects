    ...
    case 3:
      {
        ...
        switch (_tcpStatus)
        {
          case 2:
            {
              Serial.println("start case 3.1");
              _sendAT("AT+CSTT=\"internet.ideasclaro\",\"\",\"\"\r\n", 5000);
              break;
            }
          case 3:
            {
              Serial.println("start case 3.2");
